...
st.header("Welcome to My Restaurant Food Menu Demo")
...
if readme:
    ...
    st.write("""
        This is a simple binary search tree demo using [streamlit](https://streamlit.io/) library. It is hosted on [streamlit cloud](https://share.streamlit.io/). You may get the codes via [github](https://github.com/Apple-git/my2ndSTapp)
        """)

    st.write ("For more info, please contact:")

    st.write("<a href='https://www.linkedin.com/in/Yi-Pei-Ng/'>Ng Yi Pei </a>", unsafe_allow_html=True)
